...
)charset=utf8 engine=innodb auto_increment=200 comment '文章';
...
)charset=utf8 engine=innodb auto_increment=200 comment '图书表';
...
)charset=utf8 engine=innodb auto_increment=200 comment '笔记';
...
create table book_sense(
  ...
  create_time timestamp default CURRENT_TIMESTAMP not null comment '创建时间',
  update_time timestamp default CURRENT_TIMESTAMP not null comment '更新时间'
)charset=utf8 engine=innodb auto_increment=200 comment '读后感';
...
(
  ...
  unique (id)
)charset=utf8 engine=innodb auto_increment=200 comment '标签';
...
)charset=utf8 engine=innodb auto_increment=200 comment '友链';
...
)charset=utf8 engine=innodb auto_increment=200 comment '点赞日志';
...
create table log_view(
  ...
  ip varchar(64) null comment 'IP地址',
  create_date datetime null comment '创建时间'
)charset=utf8 engine=innodb auto_increment=200 comment '阅读日志';
...
)charset=utf8 engine=innodb auto_increment=200 comment '云存储资源表';
...
)charset=utf8 engine=innodb auto_increment=200 comment '推荐';
...
create table sys_menu(
  ...
  icon tinytext null,
  order_num int null
)charset=utf8 engine=innodb auto_increment=200 comment '菜单管理';
...
)charset=utf8 engine=innodb auto_increment=200 comment '系统参数';
...
)charset=utf8 engine=innodb auto_increment=200 comment '角色';
...
)charset=utf8 engine=innodb auto_increment=200 comment '角色与菜单对应关系';
...
create table sys_user(
  ...
  status tinyint null
)charset=utf8 engine=innodb auto_increment=200 ;
...
create table sys_user_role(
  ...
  role_id bigint null comment '角色ID'
)charset=utf8 engine=innodb auto_increment=200 comment '用户与角色对应关系';
...
)charset=utf8 engine=innodb auto_increment=200 comment '标签多对多维护表';
