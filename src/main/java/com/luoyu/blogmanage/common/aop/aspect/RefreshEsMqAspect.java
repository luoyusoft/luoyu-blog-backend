package com.luoyu.blogmanage.common.aop.aspect;

import com.luoyu.blogmanage.common.aop.annotation.RefreshEsMqSender;
...
public class RefreshEsMqAspect {
    ...
    @Pointcut("@annotation(com.luoyu.blogmanage.common.aop.annotation.RefreshEsMqSender)")
