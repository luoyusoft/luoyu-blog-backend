package com.luoyu.blogmanage.framework.aop.aspect;

import com.luoyu.blogmanage.common.constants.RabbitMqConstants;
import com.luoyu.blogmanage.framework.aop.annotation.RefreshEsMqSender;
...
public class RefreshEsMqAspect {
    ...
    @Pointcut("@annotation(com.luoyu.blogmanage.framework.aop.annotation.RefreshEsMqSender)")
