...
//                .select()
//                //此处添加需要扫描接口的包路径
//                .apis(basePackage("com.luoyu.blog.project.controller.applycontroller" + SPLITOR
//                        + "com.luoyu.blog.project.controller.quartzcontroller" + SPLITOR
//                        + "com.luoyu.blog.project.controller.rocketmqcontroller" + SPLITOR
//                        + "com.luoyu.blog.project.controller.rabbitmqcontroller" + SPLITOR
//                        + "com.luoyu.blog.project.controller.shirocontroller" + SPLITOR
//                        + "com.luoyu.blog.project.controller.filecontroller" + SPLITOR
//                        + "com.luoyu.blog.project.controller.websocketcontroller" + SPLITOR ))
...
//                .version("1.0.0")
//                .termsOfServiceUrl("http://localhost:8085/doc.html")
//                .contact("jinhaoxun")
//                .build();
//    }
//
