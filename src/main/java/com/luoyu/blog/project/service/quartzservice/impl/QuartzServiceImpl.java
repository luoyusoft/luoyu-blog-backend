...
import com.luoyu.blog.project.pojo.quartz.DeleteJobReq;
...
import com.luoyu.blog.framework.quartz.QuartzManager;
...
import com.luoyu.blog.common.exception.LambdaThrowingConsumer;
...
/*        SimpleTrigger cronTrigger = timingTasks.setTrigger(date);
    ...
    public ResponseResult addSimpleJobList() throws Exception{
        ...
        taskList.forEach(LambdaThrowingConsumer.throwingConsumerWrapper(n -> {
