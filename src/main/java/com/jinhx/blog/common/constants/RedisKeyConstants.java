...
public class RedisKeyConstants {
     ...
     * 用户数据 Key前缀标识
     */
    public final static String CHAT_USER_PREFIX = PROFIX + "chat:user:";

    /**
     * 用户名集合 Key
     */
    public final static String CHAT_NAME = PROFIX + "chat:name";

    /**
     * 群发消息Session Key前缀标识
     */
    public final static String CHAT_COMMON_PREFIX = PROFIX + "chat:common:";

    /**
     * 推送至指定用户消息，推送方Session Key前缀标识
     */
    public final static String CHAT_FROM_PREFIX = PROFIX + "chat:from:";
